...
const connectionString = 'postgresql://postgres:@@Monyet12!@@@db.jpstpvndxlwydmpwzetc.supabase.co:5432/postgres';
...
async function initDb() {
  try {
    ...
    const sql = `
      ...
      DROP POLICY IF EXISTS "Users can insert own prds" ON public.prds;
      ...
      DROP POLICY IF EXISTS "Users can view own prd_versions" ON public.prd_versions;
      DROP POLICY IF EXISTS "Users can insert own prd_versions" ON public.prd_versions;
